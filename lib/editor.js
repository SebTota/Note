...
/*
* Check if a user is already signed into a cloud provider and create sync object if so
 */
...
async function createNewDocument(dirPath, callback) {
    ...
    if (folderStructure.checkIfFileExists(encryption.decryptPath(dirPath))) {
        ...
        await encryption.encryptQuillOpsToDisk([], currentFile['filePath'], () => {
