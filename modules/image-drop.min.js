        ...
        _createClass(e, [{
            ...
            value: function e(t) {
                ...
                if (t.dataTransfer && t.dataTransfer.files && t.dataTransfer.files.length) {
                    ...
                    this.readFiles(t, t.dataTransfer.files, this.insert.bind(this))
                }
            }
        }, {
            key: "handlePaste",
            value: function e(t) {
                ...
                if (t.clipboardData && t.clipboardData.items && t.clipboardData.items.length) {
                    this.readFiles(t, t.clipboardData.items, function(e) {
                        return a.insert(e)
                    })
                }
            }
            ...
            value: function e(t) {
                ...
                this.quill.insertEmbed(a, 'image',t , Quill.sources.USER);
            }
        }, {
            key: "readFiles",
            value: function e(t1, t, a) {
